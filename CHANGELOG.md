## 3.0.0
  ...
  - `additional_settings` keys are now matched against the KCL 2.x configuration objects, including `PollingConfig` (e.g. `max_records`, `retry_get_records_in_seconds`, `max_get_records_thread_pool`)
